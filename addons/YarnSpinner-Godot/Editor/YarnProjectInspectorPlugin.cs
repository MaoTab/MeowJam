    ...
    public partial class YarnProjectInspectorPlugin : EditorInspectorPlugin
    {
        ...
        public override void _ParseBegin(GodotObject @object)
        {
            try
            {
                ...
                var recompileButton = new Godot.Button();
                ...
                var addTagsButton = new Godot.Button();
                ...
                var updateLocalizationsButton = new Godot.Button();
                ...
                _localeTextEntry = new LineEditWithSubmit
                {
                    ...
                    SizeFlagsHorizontal = Control.SizeFlags.ExpandFill,
                    SubmitButton = new Godot.Button {Text = "Add"},
                };
                ...
                foreach (var locale in _project.JSONProject.Localisation)
                {
                    ...
                    var pickerButton = new Godot.Button {Text = "Browse"};
                ...
                var changeBaseLocaleButton = new Godot.Button {Text = "Change"};
                ...
                var writeBaseCSVButton = new Godot.Button();
